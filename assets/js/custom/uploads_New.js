...
idfcModalSubmitButton.addEventListener("click", async (e) => {
    ...
    succesMessageConfiguration(data?.data);
    idfcLoader.style.display = "none";
    idfcModalSubmitButton.removeAttribute("disabled");
});
 ...
 * Main Submit Event
 */
sbiModalSubmitButton.addEventListener("click", async () => {
    // upload file
...
const sbi2MumbaiFileUpload = sbi2Mumbai.querySelector(
    "#sbiBoxMumbaiUploadModalFileUploadBtn"
);
...
const franchiseeDebitFileUpload = franchiseeDebit.querySelector(
    "#franchiseeUploadFileUploadBtn"
);
