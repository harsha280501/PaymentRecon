...
class CardReconciliation extends Component {
    ...
    protected function depositDates(): array {
        ...
        return DB::select('PaymentMIS_PROC_SELECT_ADMIN_CardReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :bank, :matchStatus, :PageNumber, :mainBank', [
    ...
    public function render() {
        ...
        return view('livewire.admin.tracker.card-reconciliation', [
    ...
    public function getData() {
        ...
        return DB::paginate(
            storedProcedure: 'PaymentMIS_PROC_SELECT_ADMIN_CardReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :bank, :matchStatus, :PageNumber, :mainBank',
            params: $params,
            pageNumber: $this->page
        );
    }
