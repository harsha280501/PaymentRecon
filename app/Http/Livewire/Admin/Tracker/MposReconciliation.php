...
class MposReconciliation extends Component {
    ...
    public function render() {
        ...
        //dd($this->getData());
        return view('livewire.admin.tracker.mpos-reconciliation', [
    ...
    protected function stores($tab) {
        ...
        return DB::infinite('PaymentMIS_PROC_SELECT_ADMIN_MposReconciliation :procType,:startDate, :endDate, :store,:searchString,:retekcode,:matchStatus,:bank', [
            'procType' => $tab . '-stores',
    ...
    public function getData() {
        ...
        return DB::infinite(
            'PaymentMIS_PROC_SELECT_ADMIN_MposReconciliation :procType,:startDate, :endDate,:store,:searchString,:retekcode,:matchStatus,:bank',
            $params,
            perPage: $this->perPage
        );
    }
