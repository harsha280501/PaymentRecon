...
class Dashboard extends Component {
    ...
    public function changeMainCashStats(string $procType = 'tile') {
        return Arr::first(DB::select('PaymentMIS_PROC_COMMERCIAL_HEAD_SELECT_DashboardSales :store, :from, :to, :procType', [
            'store' => $this->store,
            'from' => $this->from,
            'to' => $this->to,
            'procType' => $procType,
    ...
    public function render() {
        ...
        return view('livewire.admin.dashboard.dashboard', $dataset);
    }
}