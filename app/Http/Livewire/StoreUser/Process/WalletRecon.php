...
class WalletRecon extends Component implements WithHeaders, WithFormatting, UseExcelDataset {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_STORE_USER_Recon_Wallet_Reconciliation';
    ...
    public function render() {
        ...
        return view('livewire.store-user.process.wallet-recon', [
            'dataset' => $dataset
        ]);
    }
    ...
    public function banks($procType) {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_STOREUSER_SELECT_Process_Wallet_Recon :procType, :storeId, :startdate, :enddate, :bank, :timeline',
            [
                'procType' => $procType,
