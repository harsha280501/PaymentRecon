...
class UpiRecon extends Component implements WithHeaders, WithFormatting, UseExcelDataset {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_STORE_USER_Recon_Upi_Reconciliation';
    ...
    public function mount() {
        $this->cardBanks = $this->banks('bank-names-upi');
        $this->remarks = $this->remarks('upi');
    ...
    public function render() {
        ...
        return view('livewire.store-user.process.upi-recon', [
            'dataset' => $dataset
        ]);
    }
    ...
    public function banks($procType) {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_STOREUSER_SELECT_Process_UPI_Recon :procType, :storeId, :startdate, :enddate, :bank, :timeline',
            [
                'procType' => $procType,
    ...
    public function formatter(SpreadSheet $worksheet, $dataset): void {
        ...
        $worksheet->spreadsheet->getActiveSheet()->setCellValue('H' . 2, 'Report Name: ' . 'Upi Reconciliation');
    }
    /**
     * Get Bank Names
     * @return mixed
