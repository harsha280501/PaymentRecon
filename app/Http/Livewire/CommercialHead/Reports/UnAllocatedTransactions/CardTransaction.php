...
class CardTransaction extends Component
{
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_Reports_Un_Allocated_Transaction_Card';
    ...
    public function uploadExcelValidatedArray(array $dataset)
    {
        ...
        $_storeID = $this->_generateQuery('card', $dataset['Collection Bank']);
    ...
    public function updateUnAllocated(array $dataset): bool
    {
        ...
        $_storeID = $this->_generateQuery('card', $dataset['bank']);
    ...
    public function render()
    {
        ...
        return view('livewire.commercial-head.reports.un-allocated-transactions.card-transaction', [
            'dataset' => $dataset,
