...
class BankStatementReconciliation extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
    ...
    public function filters(string $tab = 'cash', string $type = 'stores') {
        return DB::select('PaymentMIS_PROC_COMMERCIALHEAD_SELECT_BankStatement_Reconciliation_Filters :procType', [
            'procType' => $tab . '-' . $type,
        ]);
    }
    ...
    public function render() {
        ...
        return view('livewire.commercial-head.tracker.bank-statement-reconciliation ', [
    ...
    public function getData() {
        ...
        return DB::withOrderBySelect(
            storedProcedure: 'PaymentMIS_PROC_COMMERCIALHEAD_SELECT_BankStatement_Reconciliation :procType, :store, :code, :status, :location, :from, :to',
            params: $params,
