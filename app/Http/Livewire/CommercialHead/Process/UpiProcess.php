...
class UpiProcess extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_COMMERCIAL_HEAD_Recon_UPI_Reconciliation';
    ...
    public function mount() {
        ...
        $this->filtering = ($this->store != null || $this->startDate != null) ? true : false;
    ...
    public function filters($tab) {
        ...
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_COMMERCIALHEAD_SELECT_Process_UPI_Reconciliation :procType, :store, :bank, :location,:startDate, :endDate',
            $params,
            $this->perPage,
            $this->orderBy
        );
