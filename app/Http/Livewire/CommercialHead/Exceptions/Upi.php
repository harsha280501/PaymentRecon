...
use App\Exports\CommercialHead\Exception\UPIExport;
...
class Upi extends Component {
    ...
    public function render() {
        ...
        return view('livewire.commercial-head.exceptions.upi', [
            'datas' => $dataset,
        ]);
    }
    ...
    public function export() {
        ...
        $dataset = DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Exception_UPI :procType, :bank, :from, :to',
            $params,
            $this->perPage,
            $this->orderBy
        );

        return Excel::download(new UPIExport(collect($dataset)), 'Payment_MIS_Exception_UPI_' . now()->format('Y_m_d') . '.xlsx');
    }
