...
namespace App\Http\Livewire\CommercialHead\Dashboard;
...
class Dashboard extends Component {
    ...
    public function render() {
        return view('livewire.commercial-head.dashboard.dashboard', [
    ...
    public function filtersSyncDataset(string $type) {
        ...
        return DB::select(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Dashboard_Filters :procType, :store, :brand, :location',
            $params
        );
    }
    ...
    public function changeMainStats() {
        return DB::select('PaymentMIS_PROC_COMMERCIALHEAD_SELECT_Dashboard_Summary_Dataset :procType, :storeId, :brand, :location, :timeline, :from, :to', [
