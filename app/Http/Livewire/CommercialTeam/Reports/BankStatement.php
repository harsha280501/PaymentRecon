...
class BankStatement extends Component implements UseExcelDataset, WithHeaders {
    ...
    public function download($value = ''): Collection|bool {
        return DB::withOrderBySelect('PaymentMIS_PROC_SELECT_COMMERCIALTEAM_Reports_Bank_Statement :procType, :acctNo, :search, :from, :to', [
    ...
    public function render() {
        ...
        return view('livewire.commercial-team.reports.bank-statement', [
            'mis' => $bankMIS,
            'bankTypes' => $bankTypes
        ]);
    }
