...
class WalletReconciliation extends Component {
    ...
    public function mount() {
        ...
        $this->deptDt = collect(DB::select('PaymentMIS_PROC_SELECT_AREAMANAGER_WalletReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :matchStatus, :bankName, :PageNumber, :mainBank', [
        ...
        $this->mainBankNames = collect(DB::select('PaymentMIS_PROC_SELECT_AREAMANAGER_WalletReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :matchStatus, :bankName, :PageNumber, :mainBank', [
    ...
    public function render() {
        ...
        return view('livewire.area-manager.tracker.wallet-reconciliation', [
    ...
    protected function bankNames(): array {
        return DB::select('PaymentMIS_PROC_SELECT_AREAMANAGER_WalletReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :matchStatus, :bankName, :PageNumber, :mainBank', [
            'procType' => 'banks',
            'tab' => 'wallet2bank',
            'startDate' => $this->startDate,
            'endDate' => $this->endDate,
    ...
    public function getData() {
        ...
        return DB::paginate(
            storedProcedure: 'PaymentMIS_PROC_SELECT_AREAMANAGER_WalletReconciliation :procType, :tab, :startDate, :endDate, :brand, :store, :depositDate, :searchString, :matchStatus, :bankName, :PageNumber, :mainBank',
            params: $params,
            pageNumber: $this->page
        );
