...
class CashReconciliation extends Component {
    ...
    public function mount() {
        ...
        $this->mainBankNames = DB::select('EXEC PaymentMIS_PROC_SELECT_AREAMANAGER_CashReconsiliation ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?', [
            $mainProcType,
            $mainTab,
            $mainStartDate,
            $mainEndDate,
        ...
        $this->bankNames = DB::select('EXEC PaymentMIS_PROC_SELECT_AREAMANAGER_CashReconsiliation ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?', [
            $procType,
            $tab,
            $startDate,
            $endDate,
    ...
    public function render() {
        ...
        return view('livewire.area-manager.tracker.cash-reconciliation', [
    ...
    public function getData() {
        ...
        // Procedure Instance
        return DB::paginate(
            storedProcedure: 'PaymentMIS_PROC_SELECT_AREAMANAGER_CashReconsiliation :procType, :tab, :startDate, :endDate, :brand, :store, :searchString, :bank, :matchStatus, :pageNumber, :bankName',
            params: $params,
            pageNumber: $this->page
        );
