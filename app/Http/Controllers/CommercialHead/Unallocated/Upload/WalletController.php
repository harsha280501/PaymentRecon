...
class WalletController extends Controller
{
    ...
    public function importUnallocatedWallet(Request $request)
    {
        $request->validate([
            ...
            for ($i = 2; $i <= $arrayCount; $i++) {
                ...
                if (MFLInwardStoreIDMissingTransactions::where('storeMissingUID', $uniqueID)->exists()) {
                    ...
                    if ($store) {
                        ...
                        $bankModels = [
                            'wallet-phonepay' => [MFLInwardWalletMISPhonePayPos::class, 'PhonePayPosUID'],
                            'wallet-paytm' => [MFLInwardWalletMISPayTMPos::class, 'PayTMPosUID'],
