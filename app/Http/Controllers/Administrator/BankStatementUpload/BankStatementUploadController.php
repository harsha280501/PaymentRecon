...
class BankStatementUploadController extends Controller {
    ...
    public function bankStatementHDFCUpload(Request $request) {
        ...
        try {
            ...
            $destinationPath = storage_path('app/public/admin/BankStatement/HDFC');
            $file_1_name = Carbon::now()->format('d-m-Y') . "_" . time() . '.' . $file->getClientOriginalExtension();
            $file->move($destinationPath, $file_1_name);
            $targetPath = storage_path('app/public/admin/BankStatement/HDFC/') . $file_1_name;
    ...
    public function bankStatementICICIUpload(Request $request) {
        ...
        try {
            ...
            $file = $request->file('file');
            $destinationPath = storage_path('app/public/admin/BankStatement/ICICI');
            $file_1_name = Carbon::now()->format('d-m-Y') . "_" . time() . '.' . $file->getClientOriginalExtension();
            $file->move($destinationPath, $file_1_name);
            $targetPath = storage_path('app/public/admin/BankStatement/ICICI/') . $file_1_name;
    ...
    public function bankStatementAxisUpload(Request $request) {
        ...
        try {
            ...
            $file = $request->file('file');
            $destinationPath = storage_path('app/public/admin/BankStatement/AXIS');
            $file_1_name = Carbon::now()->format('d-m-Y') . "_" . time() . '.' . $file->getClientOriginalExtension();
            $file->move($destinationPath, $file_1_name);
            $targetPath = storage_path('app/public/admin/BankStatement/AXIS/') . $file_1_name;
    ...
    public function bankStatementIDFCUpload(Request $request) {
        ...
        try {
            ...
            $file = $request->file('file');
            $destinationPath = storage_path('app/public/admin/BankStatement/IDFC');
            $file_1_name = Carbon::now()->format('d-m-Y') . "_" . time() . '.' . $file->getClientOriginalExtension();
            $file->move($destinationPath, $file_1_name);
            $targetPath = storage_path('app/public/admin/BankStatement/IDFC/') . $file_1_name;
    ...
    public function bankStatementSBIUpload(Request $request) {
        ...
        try {
            ...
            $file = $request->file('file');
            $destinationPath = storage_path('app/public/admin/BankStatement/SBI');
            $file_1_name = Carbon::now()->format('d-m-Y') . "_" . time() . '.' . $file->getClientOriginalExtension();
            $file->move($destinationPath, $file_1_name);
            $targetPath = storage_path('app/public/admin/BankStatement/SBI/') . $file_1_name;
