<section id="recent" class="process-page" x-data="{
    ...
    <x-app.commercial-team.process.sap-recon.upi-recon.filters :activeTab="$activeTab" :filtering="$filtering" :cardBanks="$cardBanks" :months="$_months" :stores="$stores" />

    <x-app.commercial-team.process.sap-recon.upi-recon.process-page :orderBy="$orderBy" :dataset="$dataset">
        <x-scrollable.scroll-body>
            ...
            {{-- modal --}}
            <x-app.commercial-team.process.sap-recon.upi-recon.modal :data="$data" :remarks="$remarks" />
            @endforeach
            @endif
        </x-scrollable.scroll-body>
    </x-app.commercial-team.process.sap-recon.upi-recon.process-page>
