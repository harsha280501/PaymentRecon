<div x-data="{
    ...
    <x-app.commercial-team.direct-deposit.filters :months="$_months" :filtering="$filtering" :stores="$stores" />
    ...
    <div class="col-lg-12 mt-3">
        <x-scrollable.scrollable :dataset="$dataset">
            ...
            <x-scrollable.scroll-body>
                ...
                <x-app.commercial-team.direct-deposit.update-modal :id="$data->directDepositUID" :data="$data" />
                @endforeach
            </x-scrollable.scroll-body>
        </x-scrollable.scrollable>
    </div>

    <x-app.commercial-team.direct-deposit.upload-modal />
