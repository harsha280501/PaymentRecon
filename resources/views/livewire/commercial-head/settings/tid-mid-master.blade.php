<div x-data="{
    ...
    <div class="dropdown mb-3">
        <button class="btn btn-secondary dropdown-toggle" style="background-color: #d3d3d3; color: black;" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
            <span x-text="selectedTid"></span> <!-- Dynamically display the selected TID -->
        </button>
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li>
                <a class="dropdown-item @tab('amexmid') active @endtab" style="color: black;" 
                   @click.prevent="updateTid('AMEX TID'); window.location.href = '{{ url('/') }}/chead/settings/tid-mid-master?t=amexmid'">
                    AMEX TID
                </a>
            </li>
            <li>
                <a class="dropdown-item @tab('icicimid') active @endtab" style="color: black;" 
                   @click.prevent="updateTid('ICICI TID'); window.location.href = '{{ url('/') }}/chead/settings/tid-mid-master?t=icicimid'">
                    ICICI TID
                </a>
            </li>
            <li>
                <a class="dropdown-item @tab('sbimis') active @endtab" style="color: black;" 
                   @click.prevent="updateTid('SBI TID'); window.location.href = '{{ url('/') }}/chead/settings/tid-mid-master?t=sbimis'">
                    SBI TID
                </a>
            </li>
            <li>
                <a class="dropdown-item @tab('hdfctid') active @endtab" style="color: black;" 
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-end"  wire:key="63dde128e69467423123423rgrkuc87bb10e55a3ajmnhvfcxzaqb4b0f25eb1546da94b5d8288d1990d862ea8b00">
            <div class="btn-group mb-1">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createPopupModal">Add MID/TID</button>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportedupload">Import Exported MID</button>
        ...
        <x-scrollable.scrollable :dataset="$dataset">
            ...
            <x-scrollable.scroll-body>
                ...
                <tr wire:key="482cd99224ad64d5e1c02c3d34d895e49850eba237a7ab61d3d401024820dccf_{{ rand() }}">
                    ...
                    <td class=""> {{ !$data->openingDt ? '': Carbon\Carbon::parse($data->openingDt)->format('d-m-Y') }} </td>
