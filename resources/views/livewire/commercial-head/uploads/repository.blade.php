...
<tbody class="mb-4">
    ...
    <tr>
        ...
        <td class="right"><a data-bs-toggle="modal" data-bs-target="#main{{ $repo->srno }}View"
                href="#">View</a></td>
    </tr>
    <x-modals.commercial-head.repository-view id="main{{ $repo->srno }}View" :repos="$mainRepos"
        :repo="$repo" />
    @endforeach
