<div x-data="{
    ...
    <x-app.commercial-head.approval-process.direct-deposit.filters :months="$_months" :filtering="$filtering" :stores="$stores" />
    ...
    <div class="col-lg-12 mt-3">
        <x-scrollable.scrollable :dataset="$dataset">
            ...
            <x-scrollable.scroll-body>
                ...
                <x-app.commercial-head.approval-process.direct-deposit.view-modal :data="$data" />
                @endforeach
            </x-scrollable.scroll-body>
