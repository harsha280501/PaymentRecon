<section id="recent" class="process-page" x-data="{
    ...
    <div class="mt-2">
        <div
            class="my-2 d-flex d-flex-mob gap-2 align-items-center @tab('wallet')
d-none
@endtab">
            ...
            <x-filters.card_recon.brand_store_location />
                ...
                <x-scrollable.scroll-body>
                    @if ($activeTab == 'card')
                        ...
                        @foreach ($dataset as $data)
                            <tr>
                                <td>{{ !$data->exDepDate ? '' : Carbon\Carbon::parse($data->exDepDate)->format('d-m-Y') }}
                                </td>
                                <td>{{ !$data->depositDate ? '' : Carbon\Carbon::parse($data->depositDate)->format('d-m-Y') }}
                                </td>
                                <td>{{ $data->storeID }}</td>
                                ...
                                <td
                                    style="font-weight: 700; color: @if ($data->status === 'Matched') teal @else red @endif">
                                    {{ $data->status }}
                                </td>
                                ...
                                <td>
                                    <a href="#" style="font-size: 1.1em" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalCenter_{{ $data->cardSalesRecoUID }}">View</a>
                                </td>
                            </tr>

                            <div class="modal fade" id="exampleModalCenter_{{ $data->cardSalesRecoUID }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:90%;">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="position: unset">
                                            ...
                                            <section class="d-flex" style="flex-direction: column; padding: 0 .8em;"
                                                id="">
                                            ...
                                            <section class="d-flex" style="flex-direction: column; padding: 0 .8em;"
                                                ...
                                                @php
                                                    $mainReconData = DB::table(
                                                        'MFL_Outward_CardSalesReco_ApprovalProcess',
                                                    )
                                                ...
                                                @foreach ($mainReconData as $main)
                                                    <div class="row mainUploadItems cash-pickup-item">
                                                        ...
                                                        <div class="col-lg-2 text-center my-auto">
                                                            <x-viewer.widget
                                                                document="{{ url('/') }}/storage/app/public/reconciliation/card-reconciliation/store-card/{{ $main->supportDocupload }}" />
                                                        </div>
                                                ...
                                                <div class="d-flex justify-content-end mt-4 mb-3 gap-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input disabled type="text" placeholder="Rs. 0.00"
                                                            id="recon-deposit-amount"
                                                            value="{{ $data->calculatedDifference }}"
                                                            class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="remarks" style="width: 400px; height: 15vh;" type="text" placeholder="Enter your comments"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            @if ($data->isPending)
                                                <button x-data
                                                    @click="(e) => handleFormData(e, 'exampleModalCenter_{{ $data->cardSalesRecoUID }}')"
                                                    style="" data-id="{{ $data->cardSalesRecoUID }}"
                                                    type="button" id="modalSubmitButton"
                                                    class="btn btn-success green">Save</button>
                                            @endif
