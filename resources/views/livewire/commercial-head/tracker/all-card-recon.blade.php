<div x-data="{
    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div>
                <div class="d-flex d-flex-mob d-flex-tab gap-2 flex-wrap">
        ...
        <x-scrollable.scrollable :dataset="$dataset">
            <x-scrollable.scroll-head>
                ...
                <tr>
                    ...
                    <th style="background: rgb(230, 230, 230)">Store ID</th>
                    <th style="background: rgb(230, 230, 230)">Retek Code</th>
                    <th style="background: rgb(230, 230, 230)">Brand</th>
                    <th style="background: rgb(230, 230, 230)">Location</th>
            ...
            <x-scrollable.scroll-body>
                ...
                <tr>
                    ...
                    <td style="background: rgba(230, 230, 230, 0.37)">{{ $data->{'Store ID'} }}</td>
                    <td style="background: rgba(230, 230, 230, 0.37)">{{ $data->{'RETEK_CODE'} }}</td>
                    <td style="background: rgba(230, 230, 230, 0.37)">{{ $data->brand }}</td>
                    <td style="background: rgba(230, 230, 230, 0.37)">{{ $data->location }}</td>
