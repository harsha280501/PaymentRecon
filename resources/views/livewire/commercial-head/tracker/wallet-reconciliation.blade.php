<div x-data="{
    ...
    <x-selection.checkboxes :selectionHas="$selectionHas">
        ...
        <x-app.commercial-head.tracker.wallet-recon.import-modal :message="$message" id="import-modal" />
                ...
                <x-scrollable.scroll-body>
                    ...
                    <tr>
                        <td class="left" scope="row" wire:key="fef19a476993669aa0730d30c7e549b204838979f0a4fd9202117d4d9f9e6cef_{{ rand() }}">
                            <input class="form-check-input" type="checkbox" value="{{ $data->walletSalesRecoUID }}" x-model="selection" />
                        </td>
                        ...
                        @if($data->isUpdated == 0)
                        <td class="text-center" wire:key="0eecf827c42c9bc78e57344d511cb4b7877afae2b3db4d585a2684f341f91f73_{{ $data->walletSalesRecoUID }}">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#sdkcskskdsfkxnskdldkzsdsdlksddlskoijfdskvm_{{ $data->walletSalesRecoUID }}"><i class="fa-solid fa-eye"></i></a>
                        </td>
                    ...
                    <div wire:key="50fd216281008abd0823129b21bf71e1b4560c3540a578ef600413c4e02af58d_{{  $data->walletSalesRecoUID }}">
                        <x-app.commercial-head.tracker.wallet-recon.update :data="$data" :message="$message" :stores="$storeIDs" />
                    </div>
