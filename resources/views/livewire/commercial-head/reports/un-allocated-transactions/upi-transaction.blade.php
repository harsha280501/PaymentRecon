<div x-data="{
        ...
        <x-scrollable.scrollable :dataset="$dataset">
            <x-scrollable.scroll-head>
                <tr wire:key="3e68c0541bfa3de72f1c4c6375b61bd562554950d9416fc289a284cc9ac2e298_{{ rand() }}">
                    <th scope="col" wire:key="47e6abd91dc1dafbc4ab04def0e22550de757959fdf119d5c00e8b4e752bba69" class="left">
            ...
            <x-scrollable.scroll-body>
                ...
                <tr wire:key="9a1e0534d0566caa73djdnknscasasredfvcvftyhsx_{{ rand() }}">
                    <td class="left" scope="row">
                        <input class="form-check-input" wire:key="9a1e0534d0566caa73djdnkn_{{ rand() }}"  type="checkbox" value="{{ $data->storeMissingUID }}" x-model="selection" />
                    </td>
                    <td class="left">
    ...
    {{-- <x-app.commercial-head.reports.unallocated.import-modal :message="$message" id="import-modal" />
     --}}
     <x-app.commercial-head.reports.unallocated.import-cardmodal :message="$message" id="import-modal" name="Unallocated Card Upload" url="/chead/upload/unallocated/upi" exampleFileLink="{{ asset('public/sample/hdfc-cash-sample.CSV') }}"/>
</div>
