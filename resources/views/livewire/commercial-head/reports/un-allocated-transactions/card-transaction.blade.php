<div x-data="{
    ...
    <x-selection.checkboxes :selectionHas="$selectionHas">
        ...
        <x-scrollable.scrollable :dataset="$dataset">
            ...
            <x-scrollable.scroll-body>
                ...
                <tr wire:key="9683ee228606fe5891156f0dcb871506d3d029b4ab77f8bf869a6fcd9f0cd30305f7833887ddcb7a1d11be7cc430bb26076b20f3f1e5d4614f39c27dca9fd117_{{ rand() }}">
                    <td class="left" scope="row" wire:key="59a5b3012d55f464d72f4342_{{ rand() }}"79f02c515b08ec593e734645e6f2d9d6e085298194a40f0630f49bc0ee35f49cb2ecd6c816112aa273efc6be43f74b53c7ece008_{{ rand() }}">
                        <input class="form-check-input" wire:key="e7f7c8da53d3541b0ee8e4c17cfdeb720a536a6ac1db1ffd32bbbfb8bd33f445928dfb42842b1c80639c0a7f68dfa8e4b4b3f590ba17d8f94c8e0490f9cce2e_{{ rand() }}" type="checkbox" value="{{ $data->storeMissingUID }}" x-model="selection" />
                    </td>
                    <td class="left">
                    ...
                    <div wire:key="0ea87000a6b9d872accb329089ca7b78e5ec436d1a4e15c01ddb94e7bb7dda326f14c89d91b4982f1cf31c42ec295be4329a8cacf8a51faf89eafde55567f2ae_{{ rand() }}"">
    ...
    <x-app.commercial-head.reports.unallocated.import-cardmodal :message="$message" id="import-modal" name="Unallocated Card Upload" url="/chead/upload/unallocated/card" exampleFileLink="{{ asset('public/sample/hdfc-cash-sample.CSV') }}"/>
</div>
