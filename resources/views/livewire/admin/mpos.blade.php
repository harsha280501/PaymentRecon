<div>
    <div class="row mt-3">
        <x-app.admin.reports.mpos.filters :stores="$stores" :filtering="$filtering" />
    </div>

    <x-app.admin.reports.mpos.table-headers :dataset="$datas">
    ...
    </x-app.admin.reports.mpos.table-headers>
