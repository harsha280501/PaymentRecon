<div>
    <div class="row mb-2">
        ...
        <div class="col-lg-12 d-flex align-items-center justify-content-end">
            ...
            <x-app.area-manager.settings.storemaster.create-popup id="storemasterCreate" />
        </div>
    </div>
    <div x-data class="col-lg-12">

        <x-livewire.area-manager.store-master-header :dataset="$datas">
        ...
        </x-livewire.area-manager.store-master-header>
