<div class="modal fade" id="exampleModalCenter_{{ $data->amexMIDUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button x-data @click="(e) => handleFormData(e, '#exampleModalCenter_{{ $data->amexMIDUID }}')" style="" data-id="{{ $data->amexMIDUID }}" type="button" id="modalSubmitButton" class="btn btn-success green">Update</button>
