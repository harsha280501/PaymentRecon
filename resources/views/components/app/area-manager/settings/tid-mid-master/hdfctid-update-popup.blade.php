<div class="modal fade" id="exampleModalCenterFourthTab_{{ $data->hdfcTIDUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button x-data @click="(e) => handleFormDatahdfc(e, '#exampleModalCenterFourthTab_{{ $data->hdfcTIDUID }}')" style="" data-id="{{ $data->hdfcTIDUID }}" type="button" id="modalSubmitButton" class="btn btn-success green">Update</button>

                    {{-- <a href="#"  data-bs-toggle="modal1" data-bs-target="#exampleModalCenterFourthTab_{{ $data->hdfcTIDUID }}"  type="button" class="btn btn-success green">Edit</a> --}}
