<div class="col-xl-4 col-12 mt-3">
    <x-app.area-manager.dashboard.banks-heading heading="Tender Wise Cash Collection" img="{{asset('assets/images/cash.png')}}" />

    <x-app.area-manager.dashboard.banks-table-headers>
...
<div class="col-xl-4 col-12 mt-3">
    <x-app.area-manager.dashboard.banks-heading heading="Tender Wise Card/UPI Collection" img="{{asset('assets/images/card.png')}}" />
    <x-app.area-manager.dashboard.banks-table-headers>
...
<div class="col-xl-4 col-12 mt-3">
    <x-app.area-manager.dashboard.banks-heading heading="Tender Wise Wallet Collection" img="{{asset('assets/images/wallet.png')}}" />
    <x-app.area-manager.dashboard.banks-table-headers>
