        ...
        <div wire:ignore class="modal-dialog modal-dialog-centered" role="document" style="max-width:80%;">
            <div wire:ignore class="modal-content">
                <div wire:ignore class="modal-header">
                    <h5 class=" modal-title">Cash Deposit Entry</h5>
                ...
                <div wire:ignore class="modal-body" x-data="{
                    ...
                    <div class="row align-items-start">
                        <div class="col-lg-4">
                            <label for="">Store ID (4 digits) *</label>
                            <input x-model="storeID" type="number" class="form-control" placeholder="Eg: 0000">
                            <span x-text="errors.storeID" class="error"></span>
                        </div>

                        <div class="col-lg-4">
                            <label for="">Retek Code (5 digits) *</label>
                            <input x-model="retekCode" type="number" class="form-control" placeholder="Eg: 0000">
