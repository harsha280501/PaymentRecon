<x-scrollable.scrollable :dataset="$dataset">
    <x-scrollable.scroll-head>
        ...
        {{-- <tr style="background: #fff">
            ...
            <th colspan="9" style="background: rgba(0, 0, 0, 0.034)">Collection</th>
            <th colspan="2">Total</th>
            <th colspan="3"></th>
        </tr> --}}

        <tr style="background: #fff">
            <th colspan="3" style="background: rgba(0, 0, 0, 0.034)"></th>
        ...
        <tr style="background: #fff">
            ...
            <th colspan="1">{{ isset($dataset[0]->TOTAL_WALLET_SALES) ? $dataset[0]->TOTAL_WALLET_SALES : "₹ 0.00" }}</th>
            <th colspan="1">{{ isset($dataset[0]->TOTAL_SALES_SUM) ? $dataset[0]->TOTAL_SALES_SUM : "₹ 0.00" }}</th>
            <th colspan="1"><b>Collection</b></th>
            <th colspan="1">{{ isset($dataset[0]->SUM_CASH_COLLECTION) ? $dataset[0]->SUM_CASH_COLLECTION : "₹ 0.00" }}</th>
        ...
        <tr>
            ...
            <th class="left" style="text-align: right !important">CASH</th>
            <th class="left" style="text-align: right !important">CARD</th>
            <th class="left" style="text-align: right !important">UPI</th>
            <th class="left" style="text-align: right !important">WALLET</th>
            <th class="left" style="text-align: right !important">TOTAL</th>
            <th class="left">Status</th>
            <th class="left" style="text-align: right !important">CASH</th>
            <th class="left" style="text-align: right !important">HDFC</th>
            <th class="left" style="text-align: right !important">AMEXPOS</th>
            <th class="left" style="text-align: right !important">SBI</th>
            <th class="left" style="text-align: right !important">ICICI</th>
            <th class="left" style="text-align: right !important">UPI</th>
            <th class="left" style="text-align: right !important">PHONEPE</th>
            <th class="left" style="text-align: right !important">PAYTM</th>

            <th class="left" style="text-align: right !important">Total Cash Collection</th>
            <th class="left" style="text-align: right !important">Total Card Collection</th>
            <th class="left" style="text-align: right !important">Total UPI Collection</th>
            <th class="left" style="text-align: right !important">Total Wallet Collection</th>
            <th class="left" style="text-align: right !important">Total Collection</th>
