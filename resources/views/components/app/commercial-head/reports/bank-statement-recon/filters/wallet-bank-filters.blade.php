<div x-data='{
    ...
    <div class="d-flex d-flex-mob gap-2" style="@if($activeTab !== 'wallet') display: none !important @endif">
        ...
        <div wire:ignore class="">
            <select id="select03-dropdown" class="custom-select select2 form-control searchField "
        ...
        {{-- <div wire:ignore class="">
            <select id="select13-dropdown" class="custom-select select2 form-control searchField"
                data-live-search="true" data-bs-toggle="dropdown" style="width: 230px">
        ...
        <div class="">
            <div style="width: 220px" wire:ignore>
                <select id="select23-dropdown" wire:model="matchStatus" style="width: 220px;"
