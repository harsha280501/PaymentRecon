<div class="col-lg-12" style="overflow-x: scroll">
    <div style="display: flex; justify-content: start; align-items: center; gap: 1em; flex-wrap: wrap" class="gap-0 gap-md-2 flex-column flex-md-row">
        ...
        @if($store && isset($storeData['Store ID']))
        <div style=" display: flex; justify-content: center;align-items: center; height: inherit; flex-wrap: wrap; flex: 1;" class="gap-0 gap-md-3">
            <h2 class="text-light font-weight-bold" style="color:#000;"><span class="text-primary">STORE ID</span>: {{ $storeData['Store ID'] ?? null}}</h2>
            <h2 class="text-light font-weight-bold" style="color:#000;"><span class="text-primary">RETEK CODE</span>: {{ $storeData['RETEK Code'] ?? null}}</h2>
            <h2 class="text-light font-weight-bold" style="color:#000;"><span class="text-primary">BRAND</span>: {{ $storeData['Brand Desc'] ?? null}}</h2>
        </div>
        @endif
    </div>
