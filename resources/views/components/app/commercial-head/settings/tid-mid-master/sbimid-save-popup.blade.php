...
}" class="modal fade setting" id="sbisave" tabindex="1" role="dialog" aria-labelledby="repo" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="d-flex" style="gap: 3">
                    <button @click="() => sbiSaveImport(file, loader)" type="button" class="btn btn-success green" id="uploadAmexBtn" style="width: fit-content">Upload</button>
                    <button type="button" class="btn grey" data-bs-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
