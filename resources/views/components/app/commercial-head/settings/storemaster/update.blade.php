<div x-data="{
    ...
    data.UniqueID = dataset['storeUID'],
    data.MGPSapCode = dataset['MGP SAP code'],
    data.storeID = dataset['Store ID'],
    data.retekCode = dataset['RETEK Code'],
    data.newIONo = dataset['New IO No'],
    data.brandDesc = dataset['Brand Desc'],
    data.storeTypeasperBrand = dataset['StoreTypeasperBrand'],
    data.channel = dataset['Channel'],
    data.franchiseeName = dataset['Store Name'],
    data.storeOpeningDate = dataset['Store opening Date'],
    data.status = dataset['SStatus'],
    data.storeClosingDate = dataset['Store Closing Date'],
    data.location = dataset['Location'],
    data.city = dataset['City'],
    data.state = dataset['State'],
    data.address = dataset['Address'],
    data.pinCode = dataset['Pin code'],
    data.located = dataset[' Located '],
    data.region = dataset['Region'],
    data.storeManagerName = dataset['Store Manager Name'],
    data.contactNo = dataset['Contact no'],
    data.ARMEmailId = dataset['ARM email id'],
    data.RMEmailId = dataset['RM email id'],
    data.NROMEmailId = dataset['NROM email id'],
    data.RCMmail = dataset['RCM mail'],
    data.correctStoreEmailId = dataset['Correct store email id'],
    data.HOContact = dataset['HO contact'],
    data.RDEmailId = dataset['RD email id']
}" class="modal fade" id="exampleModalCenter_{{ $data->{'Store ID'} }}">
            ...
            <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="eg,.. " class="form-control" x-model="data.storeTypeasperBrand">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="eg,.. Allen Solly" class="form-control" x-model="data.franchiseeName">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="date" placeholder="eg,.. " class="form-control" x-model="data.storeOpeningDate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="date" placeholder="eg,.. " class="form-control" x-model="data.storeClosingDate">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="eg,.. Bernard Hackell" class="form-control" x-model="data.storeManagerName">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="eg,..  info@abfrl-store.com" class="form-control" x-model="data.correctStoreEmailId">
                ...
                <div class="modal-footer">
                    ...
                    <div class="d-flex" style="gap: 3">
                        <button type="submit" @click.prevent="submitForm" class="btn btn-success green">Save</button>
