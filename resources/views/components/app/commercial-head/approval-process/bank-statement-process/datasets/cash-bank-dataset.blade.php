    ...
    <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cash to Bank Statement Reconciliation History</h5>
            ...
            <div class="modal-body" style="position: unset">
                ...
                <div class="table-responsive" id="history">
                    <div class="table ">
                        <div class="table-header cash-pickup-item">
                        ...
                        <div class="table-row mainUploadItems cash-pickup-item">
                            ...
                            <div class="table-cell">
                                <x-viewer.widget document="{{ url('/') }}/storage/app/public/reconciliation/cash-reconciliation/cash-bank/{{ $item->supportDocupload }}" />
                            </div>
                        </div>
