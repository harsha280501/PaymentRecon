<tr>
    ...
    <td>{{ number_format($data->tenderAmount, 2) }}</td>
    ...
    <td>{{ $data->reconStatus }}</td>
     ...
     <td> <a href="#" style="font-size: 1.1em" data-bs-target="#exampleModalCenterSecondTab_{{ $data->mposWalletSalesRecoUID }}" data-bs-toggle="modal">View</a></td> 
</tr>
