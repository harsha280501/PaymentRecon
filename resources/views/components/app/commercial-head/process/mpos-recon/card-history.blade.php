<section class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
    ...
    @php
    $mainReconData = DB::table('MLF_Outward_MPOSCardSalesReco_ApprovalProcess')
    ->where('mposCardSalesRecoUID' ,$data->mposCardSalesRecoUID)
    ->get();
    @endphp
    ...
    <div class="row mainUploadItems cash-pickup-item">
        ...
        <div class="col-lg-2 pt-2 d-flex gap-3 justify-content-center">
            ...
            <a download style="text-decoration: none" href="{{ url('/') }}/storage/app/public/reconciliation/card-reconciliation/MPOS/card-bank/{{ $main->supportDocupload }}">
