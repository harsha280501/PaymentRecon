<div class="">
    <div class="my-2 d-flex d-flex-mob gap-2 align-items-center @tab('wallet2bank') d-none @endtab">
    ...
    <div class="my-2 d-flex d-flex-mob gap-2 align-items-center @tab('store2wallet') d-none @endtab">
