<div x-data="{
    data: {
        ...
        colBank: '',
        salesDate: '',
        reconItem: '{{ $data->CashTenderBkDrpUID }}',
    },
    isValid: '{{ $data->isUpdated }}',
    ...
    validate() {
        ...
        const colBankOptions = ['SBI HCM', 'SBICASHMumbai', 'SBICASHMIS', 'ICICI Cash', 'AXIS Cash', 'HDFC', 'IDFC'];
    ...
    async getSalesData() {
        ...
        this.saleAmount = sales.tenderAmount
        this.brand = sales.brand
        return true;
    }

}" class="modal fade" id="sdkcskskdsfkxnskdldkzsdsdlksddlskoijfdskvm_{{ $data->CashTenderBkDrpUID }}" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" wire:ignore>
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Cash Reconciliation</h5>
            ...
            <form>
                <div class="modal-body">
                    ...
                    <div class="px-3" style="border-radius: 5px">
                        <div class="px-3 py-1 mt-1" style="background: #f0f0f0; border-radius: 5px">
                            ...
                            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-3" style="border-top: 2px solid #00000023; flex-wrap: nowrap">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="text-black" style="font-weight: 700">{{ $data->colBank }}</p>
                                </div>
                            ...
                            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-3" style="flex-wrap: nowrap">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="text-black" style="font-weight: 700">{{
                                        Carbon\Carbon::parse($data->mposDate)->format('d-m-Y') }}</p>
                                </div>

                                <div class="w-100">
                                    <label for="">Deposit Date</label>
                                    <p class="text-black" style="font-weight: 700">{{
                                        Carbon\Carbon::parse($data->depositDate)->format('d-m-Y')}}</p>
                                </div>

                                <div class="w-100">
                                    <label for="">Sale Amount</label>
                                    <p class="text-black" style="font-weight: 700">{{ $data->tenderAmount }}</p>
                                </div>
                        ...
                        <div x-show="isValid" class="px-3 py-1" style="background: #f9f9f9;  border-radius: 5px; margin-top: 1em">
                            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-2" style="flex-wrap: nowrap">
                                ...
                                <div class="w-100">
                                    <div class="form-group">
                                        ...
                                        <input type="date" placeholder="eg,.. " class="form-control mt-1" x-model="data.salesDate" max="{{ Carbon\Carbon::parse($data->depositDate)->format('Y-m-d') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div wire:ignore>
                                            <select id="select_tender_bank" class="form-select mt-1" x-model="data.colBank">
                                                ...
                                                <option style="padding: 0.5em 1em;" value="SBI HCM" class="form-item">SBI Cash</option>
                    ...
                    <div class="d-flex" style="gap: 3">
                        ...
                        <template x-if="1 == 1">
                            <button type="submit" class="btn btn-danger w-100 text-dark" style="padding: 0;" @click.prevent="() => {
                                confirmAction(() => { 
                                    loading = true
                                    $wire.moveToUnallocated(['{{ $data->CashTenderBkDrpUID }}'])
                                    loading = false
