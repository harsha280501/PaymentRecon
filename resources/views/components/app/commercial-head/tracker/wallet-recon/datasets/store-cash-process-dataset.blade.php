...
<tr>
    <td class="left"> {{ Carbon\Carbon::parse($data->expDepositDate)->format('d-m-Y') }} </td>
    ...
    <td class="right"> {{ number_format($data->difference, 2) }} </td>
    <td class="right"> {{ intval($data->difference) }} </td>
    <td class="right" 1style="font-weight: 700; color: green;"> {{ intval($data->sourceBankDifference) }} </td>
    <td class="right"><a data-bs-toggle="modal" data-bs-target="#exampleModalCenter_{{ $data->cashSalesRecoUID }}" href="#">View</a></td>
</tr>

<div class="modal fade" id="exampleModalCenter_{{ $data->cashSalesRecoUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-body">
                    ...
                    <div class="row" style="margin-top: -20px; margin-bottom: -20px;">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <label for="exampleInputUsername1">
                                    <h5>{{
                                                Carbon\Carbon::parse($data->expDepositDate)->format('d-m-Y')
                                                }}</h5>
                                </label>
                            </div>
                        </div>
                ...
                <section class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
                    ...
                    <div class="row cash-pickup-item">
                        ...
                        <div class="col-lg-3">
                            {{ number_format($data->sourceCashSale, 2) }}
                        </div>
                        <div class="col-lg-3">
                ...
                <div class="scroll overflow-auto">
                    ...
                    ->where('cashSalesRecoUID',$data->cashSalesRecoUID)
                    ->get();
                    ...
                    <div class="row flex-nowrap coll mt">
                        ...
                        <div class="col-lg-2 p-1 border">
                            ...
                            {{ Carbon\Carbon::parse($item->saleDate)->format('d-m-Y')}}

                        </div>

                        <div class="col-lg-2 p-1 border">

                            {{ Carbon\Carbon::parse($item->depositDate)->format('d-m-Y')}}
                        ...
                        <div class="col-lg-2 p-1 border">
                            {{ number_format($item->depositAmount, 2) }}
                        </div>
