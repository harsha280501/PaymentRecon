<section class="mainModalUploads" wire:key="{{ base64_encode('2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824') }}">
        ...
        <div wire:ignore.self class="modal-dialog modal-dialog-centered" role="document">
            <div wire:ignore.self class="modal-content">
                <div class="modal-header" wire:ignore.self>
                    <h5 class="modal-title">Import Wallet Reconcilation</h5>
