<div x-data="{
    data: {
        ...
        colBank: '',
        salesDate: '',
        reconItem: '{{ $data->walletSalesRecoUID }}',
    },
    ...
    validate() {
        ...
        const colBankOptions = ['WALLET PAYTM', 'WALLET PHONEPAY'];
    ...
    async getSalesData() {
        ...
        this.saleAmount = sales.walletSale
...
}" class="modal fade" id="sdkcskskdsfkxnskdldkzsdsdlksddlskoijfdskvm_{{ $data->walletSalesRecoUID }}" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" wire:ignore>
                        ...
                        <div class="px-3 py-1 mt-1" style="background: #f0f0f0; border-radius: 5px">
                            ...
                            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-3" style="flex-wrap: nowrap">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="text-black" style="font-weight: 700">{{ $data->walletSale }}</p>
                                </div>
                    ...
                    <div class="d-flex" style="gap: 3">
                        ...
                        <template x-if="1 == 1">
                            <button type="submit" class="btn btn-danger w-100 text-dark" style="padding: 0;" @click.prevent="() => {
                                confirmAction(() => { 
                                    loading = true
                                    $wire.moveToUnallocated(['{{ $data->walletSalesRecoUID }}'])
                                    loading = false
