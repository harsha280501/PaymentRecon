...
<div class="row mb-4">
    <div class="col-lg-9">
        <ul class="nav nav-tabs justify-content-start" role="tablist">
            ...
            <li class="nav-item">
                <a wire:click="switchTab('card-bank-process')" class="nav-link @if($activeTab === 'card-bank-process') active tab-active @endif" data-bs-toggle="
                            tab" data-bs-target="#axis" role="tab" style="font-size: .8em !important" href="#">
                    Card to Bank Statement Reconciliation Process
                </a>
            </li>
            <li class="nav-item">
                <a wire:click="switchTab('upi-bank-process')" class="nav-link @if($activeTab === 'upi-bank-process') active tab-active @endif" data-bs-toggle="
                            tab" data-bs-target="#axis" role="tab" style="font-size: .8em !important" href="#">
                    UPI to Bank Statement Reconciliation Process
                </a>
            </li>
        </ul>
    </div>
