<div class="col-lg-3 col-12">
    ...
    <x-modals.commercial-head.upload name="ICICI Cash Upload" id="iciciUploadModal" url="/admin/upload/cash/icici" exampleFileLink="{{ asset('public/sample/icici-cash-sample.CSV') }}" />
    <x-modals.commercial-head.upload name="ICICI Card Upload" id="icicicreditUploadModal" url="/admin/upload/card/icici" exampleFileLink="{{ asset('public/sample/icici-card-sample.xls') }}" />
</div>
