<div class="col-lg-2 col-12">
    ...
    <x-modals.commercial-head.upload name="IDFC Bank Upload" id="idfcUploadModal" url="/admin/upload/cash/idfc" exampleFileLink="{{ asset('public/sample/idfc-card-sample.xls') }}" />
</div>
