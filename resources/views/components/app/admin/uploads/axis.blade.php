<div class="col-lg-2 col-12">
    ...
    <x-modals.commercial-head.upload name="Axis Cash Upload" id="axisCashmodel" url="/admin/upload/add-axis-cash" exampleFileLink="{{ asset('public/sample/axis-cash-sample.CSV') }}" />
