<div class="col-lg-3 col-12">
    ...
    <x-modals.commercial-head.upload name="PHONEPAY Upload" id="PhonepayUploadModal" url="/admin/upload/phonepay" exampleFileLink="{{ asset('public/sample/phonepay-sample.csv') }}" />

    <x-modals.commercial-head.upload exampleFileLink="{{ asset('public/sample/idfc-example-csv.xlsx') }}" name="PAYTM Upload" id="PayTMUploadModal" url="/admin/upload/paytm" />
</div>
