<div class="col-lg-2 col-12">
    ...
    <x-modals.commercial-head.upload name="AMEX Card Bank Upload" id="AmexUploadModal" url="/cuser/upload/amexdata" exampleFileLink="{{ asset('public/sample/amexpos-card-sample.csv') }}" />
