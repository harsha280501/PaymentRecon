<div class="addProcess mb-3">
    <div class="d-flex justify-content-center align-items-center" style="flex-direction: column">
        <template x-if="recons.length < 6">
            <div class="btn-group">
                <button type="button" class="dropdown-toggle d-flex btn mb-1" style="background: #e7e7e7; color: #000; width: fit-content" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Reason for Difference
                </button>
                <div x-data="{
                    fillables: ['Cash Deposit by Store', 'Manual store sale'],//  -- add the manual store sale for the previous functionality
                    hasItem() {
