    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4" style="border-bottom: 2px solid #00000023">
            ...
            <div class="d-flex justify-content-end pt-4" style="flex-direction: column; ">
                ...
                <input x-on:change="recon['supportDocupload'] = Object.values($event.target.files)" type="file" data-passes-validation data-name="supportDocupload" class="form-control" id="supportDocupload" placeholder="Slip No">
