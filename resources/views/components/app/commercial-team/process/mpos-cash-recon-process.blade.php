...
<script>
    ...
    const handleAlpineSubmit = async (dataset, id, total, tenderAdj, bankAdj) => {
        ...
        dataset.map(async (item) => {
            ...
            const data = await request.http({
                url: '/suser/process/cash-recon/create/' + id
                , method: 'POST'
                , data: formData
                , processData: false
                , contentType: false
    ...
    const handleAlpineMisSubmit = async (dataset, id, total, tenderAdj, bankAdj) => {
        ...
        dataset.map(async (item) => {
            ...
            const data = await request.http({
                url: '/suser/process/mpos-cash-recon/create-mis/' + id
                , method: 'POST'
                , data: formData
                , processData: false
                , contentType: false
