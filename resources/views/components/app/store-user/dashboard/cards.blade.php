<div>
    <div class="row g-6 mb-2">
        <h2 class="text-light font-weight-bold mb-3" style="color:#000;">Reconciliation Counts</h2>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div wire:key="{{ rand() }}" title="Success but failure" x-data="increamentsCounter('{{ $tile->cash_all_records }}')" x-init="updatecounter()" x-text="Math.floor(current)" style="color:#0d6efd; text-align: center;  font: 800 40px system-ui;"></div>
                        </div>''
                        <div class="col-auto">
