...
<tr>
    ...
    <td style="text-align: right !important">{{ $data->adjAmount }} </td>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
                    ...
                    <div class="row mainUploadItems cash-pickup-item">
                        ...
                        <div class="col-lg-2">
                            <span class="left"> @if($item->approveStatus == "Rejected") <span style="font-weight: 700; color: red;">Rejected</span> @else <span style="font-weight: 700; color: green;">{{ ucfirst($item->approveStatus) }}</span> @endif </span>
                        </div>
                        ...
                        <div class="col-lg-2 pt-2 d-flex gap-3 justify-content-center align-items-start">
                            ...
                            <a download style="text-decoration: none" href="{{ url('/') }}/storage/app/public/reconciliation/upi-reconciliation/store-upi/{{ $item->supportDocupload }}">
