...
<tr>
    ...
    <td class="right"><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter_{{ $data->mposCashSalesRecoUID }}">View</a></td>



    <div class="modal fade" id="exampleModalCenter_{{ $data->mposCashSalesRecoUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:90%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">MPOS CASH TENDER TO BANK DROP RECONCILITION History</h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3" style="margin-top: -20px">
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputUsername1">
                                        <h5>{{ Carbon\Carbon::parse($data->approvedDate)->format('d-m-Y') }}</h5>
                                    </label>
                                </div>
                            </div>
                    ...
                    <section class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
                        ...
                        $historyRecords = DB::table('MFL_Outward_MPOSCashTenderBankSalesReco_ApprovalProcess')
                        ...
                        <div class="row mainUploadItems cash-pickup-item">
                            ...
                            <div class="col-lg-2">
                                ...
                                <a href="{{ url('/') }}/storage/app/public/reconciliation/mpos-reconciliation/store-mpos-tender/{{ $item->supportDocupload }}" download><i class="fa fa-download"></i> Download</a>
                                @else
                                <p>NO FILE</p>
                                @endif
                            </div>
