            ...
            <div wire:ignore.self class="modal-content">
                ...
                <div wire:ignore.self class="modal-body">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <!-- Sales Render -->
                        <div class="col-md-4">
                            <label for="cashDepositBy" class="form-label">Sales Tender</label>
                            <h5 style="border-bottom: 2px solid rgba(128, 128, 128, 0.397); padding-bottom: 1.2em" class=" text-black">{{ $data->salesTender }}</h5>
                        </div>
