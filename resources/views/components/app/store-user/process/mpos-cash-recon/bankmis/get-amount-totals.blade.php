<div class="d-flex justify-content-start align-items-center p-3 gap-3" x-data="{
    ...
    tenderAmount: parseFloat('{{ $data->bankDropAmount }}'),
    ...
    calculation() {
        ...
        return ((this.tenderAmount + tender) - (this.bankDrop + bank)) == '{{ $data->DiffAmount }}' ? 0.00 : ((this.tenderAmount + tender) - (this.bankDrop + bank))
    },
}">
