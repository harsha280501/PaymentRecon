    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-top: 2px solid #00000023">
            ...
            <div class="w-100 pt-3">
                ...
                <input x-model="recon.creditDate" type="date" data-name="saleDate" max="{{ now()->format('Y-m-d') }}" class="form-control" id="exampleInputConfirmPassword1" placeholder="Sale Date">
            </div>
