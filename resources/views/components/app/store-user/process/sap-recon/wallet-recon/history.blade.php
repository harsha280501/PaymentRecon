        ...
        <div class="p-3">
            ...
            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-2" style=" border-bottom: 2px solid #00000023; flex-wrap: nowrap">
                ...
                <div class="w-100">
                    ...
                    <p class="text-black text-start" style="font-weight: 700">{{ $item->remarks }}</p>
                </div>
                ...
                <div class="w-100">
                    ...
                    <div style="width: fit-content;">
                        <x-viewer.widget document="{{ url('/') }}/storage/app/public/reconciliation/wallet-reconciliation/store-wallet/{{ $item->supportDocupload }}" />
                    </div>
                </div>
