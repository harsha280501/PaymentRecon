    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-bottom: 2px solid #00000023">
            ...
            <div class="w-100">
                ...
                <input x-model="recon.creditDate" type="date" data-name="saleDate" class="form-control" id="exampleInputConfirmPassword1" max="{{ now()->format('Y-m-d') }}" placeholder="Sale Date">
            </div>
