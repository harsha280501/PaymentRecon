...
<section x-data class="mainModalUploads">
    <div data-url="{{ $url }}" class="modal fade" data-bs-backdrop="static" id="{{ $id }}" id="import" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3>Please download the sample file for {{ $name }} Import
                            ...
                            <div class="drag-area">
                                ...
                                <center>
                                    <input x-ref="input" id="{{ $id }}FileUploadBtn" type="file" style="margin-left:10px">
                                </center>
