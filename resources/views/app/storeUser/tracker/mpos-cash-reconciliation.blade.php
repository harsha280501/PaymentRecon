    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 500px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('store-user.tracker.mpos-cash-recon')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('store-user.tracker.mpos-cash-recon')[0].call('filterDate', dates);
    });
    ...
    searchform.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('store-user.tracker.mpos-cash-recon')[0].call('searchFilter', searchString.value);
    });
    ...
    search2form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('store-user.tracker.mpos-cash-recon')[0].call('searchFilter', search2String.value);
...
<script defer>
    ...
    document.addEventListener('livewire:load', event => {
        ...
        Livewire.on('resetAll', e => {
            // clear items
            const resetItems = ['#select5-dropdown', '#select9-dropdown', '#select8-dropdown', '#matchStatus', '#matchStatus2', '#select21-dropdown', '#matchStatus3', '#select15-dropdown', '#select23-dropdown', '#matchStatus4', '#select100-dropdown'];
