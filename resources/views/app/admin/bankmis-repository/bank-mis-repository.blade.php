    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 500px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('admin.uploads.bank-mis-repository')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.uploads.bank-mis-repository')[0].call('searchFilter', searchString.value);
