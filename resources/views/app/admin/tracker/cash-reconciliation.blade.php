    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 500px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('admin.tracker.cash-reconciliation')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.cash-reconciliation')[0].call('filterDate', dates);
    });
    ...
    searchform.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.cash-reconciliation')[0].call('searchFilter', searchString.value);
    });
    ...
    search2form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.cash-reconciliation')[0].call('searchFilter', search2String.value);
