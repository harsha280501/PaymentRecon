    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 500px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('admin.tracker.card-reconciliation')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.card-reconciliation')[0].call('searchFilter', searchString.value);
    });
    ...
    form2.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.card-reconciliation')[0].call('searchFilter', searchString2.value);
    });
    ...
    dateform.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('admin.tracker.card-reconciliation')[0].call('filterDate', dates);
    });
