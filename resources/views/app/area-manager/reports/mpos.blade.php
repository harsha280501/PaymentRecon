    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 350px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('area-manager.reports.mpos')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    const form = document.querySelector('#mpos-admin-search-form');
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('area-manager.reports.mpos')[0].call('filterDate', dates);
    });
