    ...
    <div class="col-md-12">
        ...
        <div class="tab-content tab-transparent-content bg-white" style="min-height: 500px;">
            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="home-tab">
                <section id="recent">
                    <div class="row">
                        @livewire('area-manager.reports.reports-sap')
                    </div>
                </section>
            </div>
        </div>
...
<script defer>
    const form = document.querySelector('#area-manager-sap-search-form');
    ...
    form.addEventListener('submit', e => {
        ...
        livewire.components.getComponentsByName('store-user.reports-s-a-p')[0].call('filterDate', dates);
    });
