                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @livewire('admin.settings.store-master')
                        </div>
                    </div>
                </div>
            </div>
...
<x-modals.admin.storemaster-create name="New StoreMaster Upload" id="storemastermodel" url="/admin/upload/newstoremaster" exampleFileLink="{{ asset('public/sample/newstoremaster-sample.xlsx') }}" />
</div>
...
<script>
    const createFormData = async (e) => {
        ...
        const data = await request.http({
            url: '/admin/settings/addstoremaster', // Add a forward slash before the ID
            method: 'POST'
            , data: {
