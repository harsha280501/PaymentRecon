    ...
    <div class="row mt-3">
        <div class="col-lg-12 mb-3">
            <div class="d-flex gap-2 d-flex-mob">
                ...
                <div class="">
                    <div style="width: 220px" wire:ignore>
                        <select id="select22-dropdown" class="custom-select select2 form-control searchField" data-live-search="true" data-bs-toggle="dropdown">
                            ...
                            <option selected value="" class="dropdown-item">SELECT STORE NAME</option>
                            ...
                            @if($item['Location'] != '')
                            <option class="dropdown-list" value="{{ $item['Location'] }}">{{ $item["Location"] }}</option>
                            @endif
                ...
                <form wire:ignore id="sap-search-form" class="d-flex d-flex-mob gap-2" style="flex: 1;">
                    <div>
                        <input id="startDate" style="border: 1px solid #0000003f ; border-radius: 4px; outline: none; font-size: .9em; color: #000; padding: .3em; font-family: inherit" type="date">
                    </div>
                    <div>
                        <input id="endDate" style="border: 1px solid #0000003f ; border-radius: 4px; outline: none; font-size: .9em; color: #000 ; padding: .3em; font-family: inherit" type="date">
                    </div>
