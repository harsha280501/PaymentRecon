            ...
            <div class="d-flex" style="gap: .5em; flex-wrap: wrap; @if($activeTab !=='store2wallet' ) display: none !important @endif">
                ...
                <div class="" wire:ignore>
                    <div style="width: 150px" wire:ignore>
                        <select wire:ignore id="select22-dropdown" style="min-width: 150px; width: 150px;" class="custom-select select2 form-control searchField" data-live-search="true" data-bs-toggle="dropdown" style="height: 8px !important;  min-width: 130px; width: 150px">

                            <option selected disabled value="" class="dropdown-item">SELECT STORE NAME</option>
                            <option value="" class="dropdown-item">ALL</option>
