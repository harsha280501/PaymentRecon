    ...
    <div class="mt-2">
        <div class="my-2 d-flex d-flex-mob gap-2 align-items-center">
            ...
            {{-- <div x-data="{ show: false, timeout: null }" class="d-flex align-items-center gap-2 w-mob-100"
                ...
                <div class="w-mob-100">
                    <button type="button" class="btn mb-1 w-mob-100"
                        style="background: #b5b5b6; color: #000;width:fit-content" wire:click.prevent="export">Export
                        XLSX</button>
                </div>
            </div> --}}
            ...
            <x-scrollable.scrollable :dataset="$dataset">
                <x-scrollable.scroll-head>
                    ...
                    {{-- <tr>
                        ...
                        <th>Brand</th>
                        <th>UPI</th>
                        <th>Store Sales Amount</th>
                        <th>Bank Collection Amount</th>
                        <th>Difference</th>
                        <th>Status</th>
                        <th>Recon Status</th>
                        <th>Submit Recon</th>
