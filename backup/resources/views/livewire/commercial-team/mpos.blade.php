<div x-data>
    <div class="row mt-3">
        <x-app.commercial-team.reports.mpos.filters :stores="$stores" :filtering="$filtering" :months="$_months"
            :cities="$cities" :brands="$brands" />
    </div>

    <x-app.commercial-team.reports.mpos.table-headers :orderBy="$orderBy" :dataset="$datas">
    ...
    </x-app.commercial-team.reports.mpos.table-headers>
