<div x-init="() => {
    Livewire.on('store-update:success', () => {
        succesMessageConfiguration('Store Update File Updated Successfully')
        window.location.reload()
    })
    Livewire.on('file:imported', () => {
        succesMessageConfiguration('Store Update File Uploaded Successfully')
        window.location.reload()
    })

    Livewire.on('store-update:failed', (message) => {
    ...
    <div wire:key="521e65fabae605f525a90f0ebad3e87103e9277f400586c1083513efb8f40ed5">
        <x-app.commercial-head.exceptions.import-modal :message="$message" id="import-modal" />
    </div>
    ...
    <x-scrollable.scrollable :dataset="$dataset">
        <x-scrollable.scroll-head>
            <tr>
                ...
                <td class="left">Date From</td>
                <td class="left">Date To</td>
        ...
        <x-scrollable.scroll-body>
            ...
            <tr>
                ...
                <td class="left">{{ !$data->dateFrom ? '' : Carbon\Carbon::parse($data->dateFrom)->format('d-m-Y') }}</td>
                <td class="left">{{ !$data->dateTo ? '' : Carbon\Carbon::parse($data->dateTo)->format('d-m-Y') }}</td>
