<div x-data="{
    ...
    <section id="bankmis">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9"  wire:ignore>
                <ul class="nav nav-tabs justify-content-start" role="tablist">
                    ...
                    <li class="nav-item" wire:key="2cf24dba5fb0a30e26fngfhsccvcve83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824">
                        <a href="{{ url('/') }}/chead/reports/bankmis?t=all-cash-mis" class="nav-link @if($activeTab === 'all-cash-mis') active @endif">
                            <img style="width: 30px; object-fit: cover" src="{{ asset('assets/images/cash.png') }}" />
                            CASH MIS
                        </a>
                    </li>

                    <li class="nav-item" wire:key="d872c4505c5202scassdsaqw32f7c0e11c369cda54fb7131e3f85462f331da0e68ec36c9b2ff">
                        <a href="{{ url('/') }}/chead/reports/bankmis?t=all-card-mis" class="nav-link @if($activeTab === 'all-card-mis') active @endif">
                            <img style="width: 30px; object-fit: cover; mix-blend-mode: multiply !important;" src="{{ asset('assets/images/card.png') }}" />
                            CARD MIS
                        </a>
                    </li>

                    <li class="nav-item" wire:key="ecd26292b7f02ssssssssss970ca6909abb23e1aedd0dd57d0ee9ff40bf3f30c325e3e453a">
                        <a href="{{ url('/') }}/chead/reports/bankmis?t=all-upi-mis" class="nav-link @if($activeTab === 'all-upi-mis') active @endif">
                            <img style="width: 30px; object-fit: cover; mix-blend-mode: multiply !important;" src="{{ asset('assets/images/upi.png') }}" />
                            UPI MIS
                        </a>
                    </li>

                    <li class="nav-item" wire:key="d7914fe546b68468sdassd8bb95f4f888a92dfc680603a75f23eb823658031fff766d9">
                        <a href="{{ url('/') }}/chead/reports/bankmis?t=all-wallet-mis" class="nav-link @if($activeTab === 'all-wallet-mis') active @endif">
        ...
        <div class="row" style="border-top: 2px solid lightgray;" wire:key="2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824">
            <div class="my-2 d-flex d-flex-mob gap-2 align-items-center">
                ...
                <div wire:ignore class="mt-1 w-mob-100" wire:key="d7914fe546b684688bb95f4f888a92dfc680603a75f23eb823658031fff766d9">
                    <div wire:key="ecd26292b7f02970ca6909abb23e1aedd0dd57d0ee9ff40bf3f30c325e3e453a" wire:ignore.self>
                        <template x-if="$wire.activeTab == 'all-card-mis'" wire:key="522366a1b1721036b37522f091c2fe5b9aa8011ab39da79ef5edc8a49b96bdce">
                        ...
                        <template x-if="$wire.activeTab == 'all-wallet-mis'" wire:key="5111292cc76e40a363f8f0622f842c633cdbf473a4b3686222e7fd8b68fc3c04" wire:ignore>
                            <div class="select mb-1 w-mob-100" style="width: 200px" wire:ignore.self>
                                <select x-on:change="$wire.bankName = $event.target.value" id="select22-dropdown">
                                    <option selected disabled value="" class="">SELECT BANK NAME</option>
                        ...
                        <template x-if="$wire.activeTab == 'all-cash-mis'" wire:key="991f4756d8bb9de0b2e0c2f0d9463d74cd067f42d2cd8ddefb7474a0112d2406">
                ...
                <div class="mt-2 w-mob-100" wire:ignore.self>
                    <x-filters._filterStore data="stores" arr="store" key="SGVsbG9rbmRrbmNkYw" update="store" initialValue="SELECT A STORE" />
                </div>
