<div x-data="{
    ...
    <div class="row mb-1" wire:key="b7e817db68d62c4ddc57eaa5e724aa532ed938b7b2b5d2ba66f8b658433bd0ea609a2c72b2b731e6ffe3f53fa375db1825b8906eb75dad7e08asddddsdsdf0b4d803d37afb">
        <div class="col-lg-6" wire:key="b7e817db68d62c4ddc57eaa5e724aa532ed938b7b2b5d2ba66f8b658433bd0ea609a2c72b2b731e6ffe3f53fa375db1825b8906eb75asdassqwqddfdfvdad7e08asddddsdsdf0b4d803d37afb">
            <ul class="nav nav-tabs justify-content-start" role="tablist" wire:key="63dde8e69467423423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                <li class="nav-item" wire:key="63dde8e694674234cvsxasx_v23rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                    <a @click.pervent="() => {
                        reset()
                        window.location.href = '{{ url('/') }}/chead/settings/tid-mid-master' + '?t=amexmid'
                    }" class="nav-link @tab('amexmid') active tab-active @endtab" data-bs-toggle="tab" href="#" role="tab" style="font-size: .8em !important">AMEX TID
                    </a>
                </li>
                <li class="nav-item" wire:key="63dde128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                    <a @click.pervent="() => {
                        reset()
                ...
                <li class="nav-item"  wire:key="61113dde128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                    <a @click.pervent="() => {
                        reset()
                ...
                <li class="nav-item"  wire:key="63dd1232e128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                    <a @click.pervent="() => {
                        reset()
                ...
                <li class="nav-item"  wire:key="63dde128e6946gf45447423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                    <a @click.pervent="() => {
                        reset()
                        window.location.href = '{{ url('/') }}/chead/settings/tid-mid-master' + '?t=unallocated'
                    }" class="nav-link @tab('unallocated') active tab-active @endtab" data-bs-toggle="
                            tab" href="#" role="tab" style="font-size: .8em !important">
                        Un-allocated TID
                    </a>
                </li>
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-end"  wire:key="63dde128e69467423123423rgrkuc87bb10e55a3ajmnhvfcxzaqb4b0f25eb1546da94b5d8288d1990d862ea8b00">
            @tab('amexmid')
            <div class="btn-group mb-1">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createPopupModal">Add
                        MID/TID</button>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportedupload">Import Exported MID
                    </button>
            ...
            @endtab
            @tab('icicimid')
            <div class="btn-group mb-1"  wire:key="63dde128e694671223232545568423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createPopupModal">Add
                        MID/TID</button>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportedupload">Import Exported MID
            ...
            @endtab
            @tab('sbimis')
            <div class="btn-group mb-1"  wire:key="63dde128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00ASSDCSXXC">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createPopupModal">Add
                        MID/TID</button>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportedupload">Import Exported MID
            ...
            @endtab
            @tab('hdfctid')
            <div class="btn-group mb-1"  wire:key="63dde128e6946742312342SSDFDFFSDSD3rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createPopupModal">Add
                        MID/TID</button>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportedupload">Import Exported TID
                    </button>
                    <button class="btn btn-primary" @click="() => {
                        $wire.export()
                    }">Export
            ...
            @tab('unallocated')
            <div class="btn-group mb-1" wire:ignore  wire:key="63dsdccscscxcxcxznmn1211de128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00">
                <div class="mb-2" style="float: right;">
                    <button class="btn btn-primary" @click="() => {
                        $wire.export()
                    }">Export
    ...
    <div class="mt-2 mb-2">
        <x-app.commercial-head.settings.tid-mid-master.filters :banks="$banks" :months="$_months" :activeTab="$activeTab" :filtering="$filtering" :brands="$brands" :stores="$stores" />
    </div>

    <div class="col-lg-12" wire:key="b7e817db68d62c4ddc57eaa5e724aa532ed938b7b2b5d2ba66f8b658433bd0ea609a2c72b2b731e6ffe3f53fa375db1825b8906eb75dad7e08f0b4d803d37afb">
        <x-scrollable.scrollable :dataset="$dataset">
            ...
            <x-scrollable.scroll-body>
                ...
                <tr wire:key="482cd99224ad64d5e1c02c3d34d895e49850eba237a7ab61d3d401024820dccf_{{ rand() }}">
                    ...
                    <td class=""> {{ !$data->closureDate ? '' : Carbon\Carbon::parse($data->closureDate)->format('d-m-Y') }} </td>
                ...
                @tab('icicimid')
                @foreach ($dataset as $data)
                <tr wire:key="a7edc2f53c71c389a54be50abb838efac647fedfcdc7fbf203a1652f4aa79e31_{{ rand() }}">
                    <td class=""> {{ $data->MID }} </td>
                    <td class=""> {{ $data->storeID }} </td>
                    <td class=""> {{ Carbon\Carbon::parse($data->openingDt)->format('d-m-Y') }} </td>
                    <td class=""> {{ $data->newRetekCode }} </td>
                ...
                @tab('sbimis')
                @foreach ($dataset as $data)
                <tr wire:key="ecf45eac23b75b61379dfd77044759c34bbf8cc28ce8cf1e583cee3c792900e0asksmmdnakj_{{ rand() }}">
                    <td class=""> {{ $data->MID }} </td>
                    <td class=""> {{ $data->storeID }} </td>
                    <td class=""> {{ Carbon\Carbon::parse($data->openingDt)->format('d-m-Y') }} </td>
                    <td class=""> {{ $data->newRetekCode }} </td>
                ...
                @tab('hdfctid')
                @foreach ($dataset as $data)
                <tr wire:key="b1fcb71916f621168d9a4ca7d8ba397d991861ee274007e867d9a0ab7f222zxxczxczxb2a_{{ rand() }}">
                ...
                @tab('unallocated')
                @foreach ($dataset as $data)
                <tr  wire:key="63dde128e69467423123423rgrkuc87bb10e55a3ab4b0f25eb1546da94b5d8288d1990d862ea8b00_{{ rand() }}">
        ...
        <div wire:key="d7914fe546b684688bb95f4f888a92dfc680603a75f23eb823658031fff766d9">
            <x-app.commercial-head.settings.tid-mid-master.partials.import-popup id="exportedupload" :message="$message" />
