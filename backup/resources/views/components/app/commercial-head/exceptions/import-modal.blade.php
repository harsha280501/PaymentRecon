<section class="mainModalUploads" wire:key="{{ base64_encode('jdsdidjsodjsajdsfokj') }}">
    <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="importModalRef">
        <div wire:ignore.self class="modal-dialog modal-dialog-centered" role="document">
            <div wire:ignore.self class="modal-content">
                <div class="modal-header" wire:ignore.self>
                    <h5 class="modal-title">Import Store Update History</h5>
