        ...
        <div class="modal-content" wire:ignore.self>
            <form @submit.prevent="submitForm" wire:ignore.self>
                ...
                <div class="modal-body" wire:ignore>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            <label style="color:#000">Revelance</label>
                            <input type="text" class="form-control" x-model="form.relevance">
                            <span x-show="errors.relevance" class="text-danger" x-text="errors.relevance"></span>
                        </div>
                        <div class="form-group col-lg-6">
                            <label style="color:#000">EDC Service Provider</label>
                            <input type="text" class="form-control" x-model="form.EDCServiceProvider">
                            <span x-show="errors.EDCServiceProvider" class="text-danger" x-text="errors.EDCServiceProvider"></span>
                        </div>
                    </div>
                </div>
