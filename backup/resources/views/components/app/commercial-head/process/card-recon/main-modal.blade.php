    ...
    <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:90%;">
        <div class="modal-content">
                ...
                <section class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
                    ...
                    <div class="row mainUploadItems cash-pickup-item">
                        ...
                        <div style="width: fit-content;">
                            <x-viewer.widget document="{{ url('/') }}/storage/app/public/reconciliation/card-reconciliation/card-bank/{{ $main->supportDocupload }}" />
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="d-flex justify-content-end mt-4 mb-3 gap-3">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="text" placeholder="Rs. 0.00" id="recon-deposit-amount" value="{{ number_format($data->depositAmount) }}" class="form-control">
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button x-data @click="(e) => cardApproval(e, 'exampleModalCenterSecondTab_{{ $data->cardMisBankStRecoUID }}')" style="" data-id="{{ $data->cardMisBankStRecoUID }}" type="button" id="modalSubmitButton" class="btn btn-success green">Save</button>
