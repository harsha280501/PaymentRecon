    ...
    <div class="row">
        ...
        <div class="">
            ...
            <form @submit.prevent="$wire.filter(_filter())" class="mb-1 ms-1 justify-mob main-start" style="display: flex; justify-content: center; align-items: center; gap: 1em;">
                ...
                <div class="mt-2">
                    {{-- <x-filters.extensions.alpine_dropdown :dataset="$brands" initialValue="SELECT A BRAND" keys="Brand" /> --}}
                    <div x-init="_brand" wire:ignore>
                        <select x-ref="_selectBrand" data-placeholder="SELECT A BRAND" class="w-mob-100" style="width: 200px">
                ...
                <div x-init="_store" class="mt-2 w-main-100" wire:ignore>
                    <select class="w-main-100" x-ref="select" data-placeholder="SELECT STORE ID" style="width: 200px" wire:ignore>
                        <option></option>
                        <option value="">All</option>
                        ...
                        $item = (array) $item;
                        @endphp
                        <option value="{{ $item['retekCode'] }}">{{ $item["retekCode"] }}</option>
                        @endforeach
                    </select>
                </div>
