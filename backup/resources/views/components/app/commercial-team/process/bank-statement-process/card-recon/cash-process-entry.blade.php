    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-center align-items-center gap-3 mb-3 pt-4" style="border-top: 2px solid #00000023;">
            <div style="width: 150px !important" x-data="{
                ...
                <div style="width: inherit !important" class="select my-1">
                    <select style="width: inherit !important" x-on:change="recon['bankName'] = $event.target.value">
            ...
            <div class="w-100">
                ...
                <input x-model="recon.creditDate" type="date" max="{{ now()->format('Y-m-d') }}" data-name="saleDate" class="form-control" id="exampleInputConfirmPassword1" placeholder="Sale Date">
            </div>
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4" style="border-bottom: 2px solid #00000023">
            ...
            <div class="d-flex justify-content-end pt-4" style="flex-direction: column; ">
                ...
                <input id="supportDocupload" x-on:change="recon['supportDocupload'] = Object.values($event.target.files)" type="file" data-passes-validation data-name="supportDocupload" class="form-control" id="exampleInputConfirmPassword1" placeholder="Slip No">
