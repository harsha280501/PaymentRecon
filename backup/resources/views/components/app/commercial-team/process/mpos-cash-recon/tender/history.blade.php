...
<div>
    @php
    $historyRecords = App\Models\Process\MPOS\Cash\CashReconApproval::where('mposCashSalesRecoUID',$data->mposCashSalesRecoUID)
    ->get();
    @endphp
        ...
        <div class="p-3">
            ...
            <div class="d-flex justify-content-center align-items-start gap-3 mb-1 pt-2" style=" border-bottom: 2px solid #00000023; flex-wrap: nowrap">
                ...
                <div class="w-100">
                    ...
                    <p>NO FILE</p>
                    @else
                    <a download style="text-decoration: none; display: block;" href="{{ url('/') }}/storage/app/public/reconciliation/mpos-reconciliation/store-mpos-tender/{{ $item->supportDocupload }}">
