<div class="col-lg-3 col-12">
    ...
    <x-modals.commercial-head.upload name="SBI Cash Upload" id="sbiUploadModal" url="/cuser/upload/add-sbi-cash" exampleFileLink="{{ asset('public/sample/sbi-cash-sample.xlsx') }}" />
    <x-modals.commercial-head.upload name="SBI Card Upload" id="sbiCardUploadModal" url="/cuser/upload/add-sbi-card" exampleFileLink="{{ asset('public/sample/sbi-card-sample.csv') }}" />
</div>
