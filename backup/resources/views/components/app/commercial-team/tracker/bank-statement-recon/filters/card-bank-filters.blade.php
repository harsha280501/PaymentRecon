<div x-data='{
    ...
    <div class="d-flex d-flex-mob gap-2" style="@if($activeTab !== 'card') display: none !important @endif">
        ...
        <div wire:ignore class="">
            <select id="select02-dropdown" class="custom-select select2 form-control searchField "
        ...
        {{-- <div wire:ignore class="">
            <select id="select12-dropdown" class="custom-select select2 form-control searchField"
                data-live-search="true" data-bs-toggle="dropdown" style="width: 230px">
        ...
        <div class="">
            <div style="width: 220px" wire:ignore>
                <select id="select22-dropdown" wire:model="matchStatus" style="width: 220px;"
