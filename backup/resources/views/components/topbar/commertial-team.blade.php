                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                            <div class="p-2">
                                ...
                                <form id="logout-form" action="{{ url('/') }}/cuser/logout" method="POST" style="display: none;">
                                    @csrf
                                </form>
                            </div>
                        </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                    ...
                    <div class="p-2">
                        <h5 class="dropdown-header text-uppercase ps-2 text-dark">Welcome {{auth()->user()->name}}</h5>
                        <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="{{ url('/') }}/cuser/changepwd">Change Password </a>
                        <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="{{ url('/') }}/chead/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <span>Log Out</span>
                            <i class="mdi mdi-logout ms-1"></i>
                        </a>
