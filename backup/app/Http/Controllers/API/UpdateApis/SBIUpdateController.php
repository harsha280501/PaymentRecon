...
class SBIUpdateController extends Controller {
    ...
    public function __invoke(Request $request) {
        ...
        $validate = Validator::make($request->only(['bank']), [
            "bank" => 'required|string|min:4|in:agency,agencycode,cash,cash_store,AxisCash,AxisCashReteck,HdfcCash,IdfcCash,IciciCash,Wallet_Phonepay_StoreID,Wallet_Phonepay_Terminal',
        ]);
