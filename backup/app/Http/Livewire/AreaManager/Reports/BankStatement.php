...
class BankStatement extends Component {
    ...
    public function render() {
        ...
        // dd($this->loading);
        // main view
        return view('livewire.area-manager.reports.bank-statement', [
            'mis' => $bankMIS,
            'bankTypes' => $bankTypes
        ]);
    }
    ...
    public function bankTypes() {
        // $this->loading = true;
        return DB::select('PaymentMIS_PROC_SELECT_AREA_MANAGER_ACCOUNT_BANK :BANK_NAME', [
    ...
    public function getHDFCData() {
        return DB::infinite('PaymentMIS_PROC_SELECT_AREA_MANAGER_BANKSTATEMENT_HDFC :acctNo', [
            'acctNo' => $this->bankType
        ], $this->perPage);
    }

    public function getAxisData() {
        return DB::infinite('PaymentMIS_PROC_SELECT_AREA_MANAGER_BANKSTATEMENT_AXIS :acctNo', [
            'acctNo' => $this->bankType
        ], $this->perPage);
    }
    ...
    public function getICICIData() {
        return DB::infinite('PaymentMIS_PROC_SELECT_AREA_MANAGER_BANKSTATEMENT_ICICI :acctNo', [
            'acctNo' => $this->bankType
        ], $this->perPage);
    }
    ...
    public function getSBIData() {
        return DB::infinite('PaymentMIS_PROC_SELECT_AREA_MANAGER_BANKSTATEMENT_SBI :acctNo', [
            'acctNo' => $this->bankType
        ], $this->perPage);
    }
    ...
    public function getIDFCData() {
        return DB::infinite('PaymentMIS_PROC_SELECT_AREA_MANAGER_BANKSTATEMENT_IDFC :acctNo', [
            'acctNo' => $this->bankType
        ], $this->perPage);
    }
}