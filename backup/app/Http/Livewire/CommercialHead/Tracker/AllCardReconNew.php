...
class AllCardReconNew extends Component implements UseExcelDataset {
    ...
    public function filtersSyncDataset(string $type) {
        ...
        return DB::select(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_All_Card_Reconciliation_Filters :procType, :store, :brand, :location',
            $params
        );
    }
    ...
    public function getTotals() {
        ...
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_All_Card_Reconciliation :procType, :store, :brand, :location, :status, :from, :to',
            $params,
            $this->perPage,
            $this->orderBy
        );
    ...
    public function render() {
        return view('livewire.commercial-head.tracker.all-card-recon-new', [
