...
class CardReconProcess extends Component implements UseExcelDataset {
    ...
    public function download($value = ''): Collection|bool {
        ...
        // Procedure Instance
        return DB::infinite(
            storedProcedure: 'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_Card_Reconciliation_Approved_Process :procType, :store, :from, :to, :status',
            params: $params,
