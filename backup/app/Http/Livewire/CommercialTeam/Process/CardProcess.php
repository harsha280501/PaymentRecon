...
class CardProcess extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_Recon_Card_Reconciliation';
    ...
    public function render() {
        ...
        return view('livewire.commercial-team.process.card-process', [
            'dataset' => $dataset
        ]);
    }
    ...
    public function filters($tab) {
        ...
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_COMMERCIALTEAM_SELECT_Process_Card_Reconciliation :procType, :storeId, :bank, :startdate, :enddate',
            $params,
            $this->perPage,
            $this->orderBy
        );
    ...
    public function download($value = ''): Collection|bool {
        ...
        return DB::withOrderBySelect('PaymentMIS_PROC_COMMERCIALTEAM_SELECT_Process_Card_Reconciliation :procType, :storeId, :bank, :startdate, :enddate', $params, $this->perPage, $this->orderBy);
    }
