...
class UpiReconciliation extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_COMMERCIAL_TEAM_Tracker_UPI_Reconciliation';
    ...
    public function filtersSyncDataset(string $type) {
        ...
        return DB::select(
            'PaymentMIS_PROC_SELECT_COMMERCIALTEAM_Tracker_UPI_Reconciliation_Filters :procType, :store, :brand, :location',
            $params
        );
    }
    ...
    public function getTotals() {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_COMMERCIALTEAM_Tracker_UPI_Reconciliation :procType, :storeId, :brand, :location, :status, :timeline, :startDate, :endDate', [
                'procType' => 'get_totals',
                'storeId' => $this->_store,
                'brand' => $this->_brand,
                'location' => $this->_location,
    ...
    public function render() {
        return view('livewire.commercial-team.tracker.upi-reconciliation', [
