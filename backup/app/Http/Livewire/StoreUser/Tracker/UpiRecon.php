...
class UpiRecon extends Component implements WithHeaders, WithFormatting, UseExcelDataset {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_Tracker_STORE_USER_Upi_Reconciliation';
    ...
    public function render() {
        ...
        return view('livewire.store-user.tracker.upi-recon', [
    ...
    public function getTotals() {
        ...
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_STOREUSER_Tracker_UPI_Reconciliation :procType, :startDate, :endDate, :storeID, :bank, :timeline',
            $params,
            $this->perPage,
            $this->orderBy
        );
