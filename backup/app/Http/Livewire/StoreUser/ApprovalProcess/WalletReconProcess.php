...
class WalletReconProcess extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
    ...
    public function download(string $type = ''): Collection|bool {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_STOREUSER_Approved_Process_Wallet_Reconciliation :procType, :store, :from, :to, :status',
            [
                'procType' => 'export',
    ...
    public function getData() {
        ...
        // Procedure Instance
        return DB::withOrderBySelect(
            storedProcedure: 'PaymentMIS_PROC_SELECT_STOREUSER_Approved_Process_Wallet_Reconciliation :procType, :store, :from, :to, :status',
            params: $params,
